...
public class LabelView extends LinearLayout {
    ...
    /**
     * Put the label in the corresponding position of the corresponding RelativeLayout, consider the introduction of postion as a parameter...
     *
     * @param parent
     * @param left
     * @param top
    ...
    public void wave() {
        ...
        sa.setRepeatCount(10);// Set the loop
        AlphaAnimation aniAlp = new AlphaAnimation(1, 0.1f);
        aniAlp.setRepeatCount(10);// Set the loop
